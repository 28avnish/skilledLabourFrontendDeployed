...
export function Services() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = (await axios.get("https://skilledlabour.onrender.com/api/services/getallservices")).data;
        setservices(data);
        setloading(false);
      } catch (error) {
        console.log(error);
...
export function Bookings() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = (await axios.get("https://skilledlabour.onrender.com/api/bookings/getallbookings")).data;
        setbookings(data);
        setloading(false);
      } catch (error) {
        console.log(error);
...
export function Users(){
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const data = (await axios.get("https://skilledlabour.onrender.com/api/users/getallusers")).data;
            setusers(data);
            setloading(false);
          } catch (error) {
            console.log(error);
...
export function Addservice(){
   ...
   async function addService(){
        ...
        try {
            setloading(true)
            const result= (await axios.post("https://skilledlabour.onrender.com/api/services/addservice" , newservice)).data
            console.log(result)
            setloading(false)
